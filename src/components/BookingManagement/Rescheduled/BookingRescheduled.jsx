...
const BookingRescheduled = (props) => {
    ...
    return (
        <div className="relative px-[30px] py-[30px]">
            <p className="text-[22px] text-[#4B465C] font-semibold">
                {
                    viewBooking ? <p><span className="text-[#4B465C90]">Bookings / Rescheduled</span> / View </p> : (
                        <p className="text-[22px] text-[#4B465C] font-semibold"><span className="text-[#4B465C90]">Bookings</span> / Rescheduled</p>
                    )
                }
