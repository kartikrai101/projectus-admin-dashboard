        ...
        <div className=" mt-[20px]">
            <form>
                <div className="mt-[30px]">
                    ...
                    <div className="flex justify-between space-x-3 mt-[15px]">
                        ...
                        <div className="flex flex-col items-start w-[33%]">
                            ...
                            <input required ref={linkRef} type="text" name="link" placeholder="Paste the CTA link" className="text-[#4B465C80] border-[1px] border-[#DBDADE] rounded-[5px] w-full px-[10px] py-[3px]" />
                        </div>
                    </div>
                    <div className="flex justify-between space-x-3 mt-[15px]">
                        <div className="flex flex-col items-start w-[33%]">
                ...
                <div className="flex w-full justify-center items-center mt-[30px]">
                    <div onClick={() => {addBannerHandler()}} className="bg-[#3C3836] text-white text-center rounded-[5px] px-[20px] py-[3px] cursor-pointer font-medium">Add Banner</div>
                </div>
            </form>
        </div>
        {
