...
const DeleteVlogModal = ({deleteBannerName, setDeleteBanner, setBannerDeleted}) => {
        ...
        <>
            ...
            <div className='min-w-[500px] flex flex-col items-center p-[20px] fixed z-1000 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#FFFFFF] rounded-[10px] shadow-xl'>
                ...
                <div className='flex justify-center items-center space-x-3 mt-[35px]'>
                    <button onClick={() => setDeleteBanner(false)} className='px-[15px] py-[5px] text-center text-[#A8AAAE] rounded-[5px] border-[1px] border-[#A8AAAE29] bg-[#A8AAAE29]'>CANCEL</button>
                    <button onClick={() => {
                        setDeleteBanner(false)
                        setBannerDeleted(true)
                    }} className='bg-[#DC7A39] text-white px-[15px] py-[5px] rounded-[5px] text-center'>DELETE</button>
                </div>
            </div>
...
export default DeleteVlogModal;