        ...
        <div className=" mt-[20px]">
            <form>
                ...
                <div className="flex w-full justify-center items-center mt-[30px]">
                    <div onClick={() => {addServiceHandler()}} className="bg-[#3C3836] text-white text-center rounded-[5px] px-[20px] py-[3px] cursor-pointer font-medium">Add Service</div>
                </div>
            </form>
        </div>
        {
            showSuccessBanner ? 
            <SuccessModal setAdd={setAddService} name={"Service"} /> : null
        }
        </>
    );
}
