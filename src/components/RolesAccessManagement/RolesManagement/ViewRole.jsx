const ViewRole = ({setViewRole, roleDetails}) => {
    return (
        <div className="w-full">
            <div className="w-full flex justify-between space-x-4">
                <div className="w-[33%]">
                    <p className="text-[#4B465C]">Role ID</p>
                    <input disabled type="text" value={roleDetails.roleId} className="rounded-[5px] text-[#4B465C] border-[1px] px-[10px] h-[36px] border-[#DBDADE] w-full" />
                </div>
                <div className="w-[33%]">
                    <p className="text-[#4B465C]">Role Name</p>
                    <input disabled type="text" value={roleDetails.roleName} className="rounded-[5px] text-[#4B465C] border-[1px] px-[10px] h-[36px] border-[#DBDADE] w-full" />
                </div>
                <div className="w-[33%]">
                    <p className="text-[#4B465C]">Total Permissions</p>
                    <input disabled type="number" value={roleDetails.totalPermissions} className="rounded-[5px] text-[#4B465C] px-[10px] h-[36px] border-[1px] border-[#DBDADE] w-full" />
                </div>
            </div>
            ...
            <div className='flex items-center mt-[25px] space-x-5 justify-center'>
                <button onClick={() => setViewRole(false)} className='bg-[#3C3836] text-white text-center w-[70px] py-[3px] rounded-[5px] text-[15px] font-medium'>Back</button>
            </div>
        </div>
    );
}
