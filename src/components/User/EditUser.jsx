    ...
    return (
        <div className=" mt-[20px]">
            <form>
                ...
                <div className="flex w-full justify-center items-center mt-[30px] space-x-3">
                    <div onClick = {() => setEditUser(false)} className="bg-[#3C3836] text-white text-center rounded-[5px] text-[15px] font-medium px-[20px] py-[5px] cursor-pointer font-medium">Save</div>
                    <div onClick = {() => setEditUser(false)} className="bg-[#A8AAAE29] text-[#3C3836] text-center rounded-[5px] px-[20px] py-[5px] cursor-pointer font-medium">Cancel</div>
                </div>
            </form>
        </div>
    );
